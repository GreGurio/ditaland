...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  var unlock = true; //IsHidden (for forms)
  ...
  function popup_close(item) {
    ...
    if (unlock) {
      if (!item) {
        for (var _i2 = 0; _i2 < popups.length; _i2++) {
          var _popup = popups[_i2];
